...
function TabComponent() {
    ...
    const [showAlertBox, setShowAlertBox] = useState(false); // 모달 표시 여부
    ...
    // 모달에서 취소 버튼을 눌렀을 때 모달 닫기
    const handleAlertCancelDelete = () => {
        setShowAlertBox(false); // 모달 닫기
    };
    // ----------------------------------- 페이지 네이션
    ...
    const alertMessage = '이미 중복된 병원 코드 입니다.';
    ...
    return (
        <div className="listContainer container_flex">
            <div className="TabSetting container_left">
                ...
                {showAlertBox && <AlertBox message={alertMessage} onCancel={handleAlertCancelDelete} />}
            </div>
            <div className="tabs">
                <button
